  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <motion.div
          className="relative w-full h-[350px] rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-xl transition-shadow"
          onClick={onClick}
      ...
      <div className="grid grid-cols-3 gap-3 mb-6 scale-[0.95]">
        {/* Price Button */}
        <motion.div 
