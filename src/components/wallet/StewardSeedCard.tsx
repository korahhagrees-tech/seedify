  ...
  return (
    ...
    >
      ...
      <div className="relative mb-6 -mt-12 lg:-mt-8 md:-mt-8 overflow-hidden scale-[1.1] lg:scale-[1.0] pt-6 pb-2 md:scale-[1.0] z-50">
        <div className="w-[492px] lg:w-[480px] md:w-[480px] rounded-full py-1 pl-16 pr-14 -ml-8 lg:-ml-1 md:ml-0 mt-2 bg-gradient-to-r from-gray-200 via-white to-gray-200 border-1 border-black scale-[0.75] lg:scale-[0.8] md:scale-[0.8] z-50">
        ...
        <div className="flex gap-8 items-start -ml-1 scale-[1.05] lg:scale-[0.95] md:scale-[0.95] -mt-2 lg:-mt-6 md:-mt-6">
          ...
          <div className="flex-1 space-y-1 pt-4 -ml-4">
            ...
            <div className="space-y-3 max-w-sm scale-[0.7] -ml-6">
              <button
                onClick={onTendSeed}
                className="w-full px-10 py-2 text-xl lg:text-[22px] md:text-[22px] border-1 border-black rounded-full hover:bg-gray-50 transition-colors peridia-display leading-relaxed whitespace-nowrap"
              >
                <div className="scale-[1.15] lg:scale-[1.2] md:scale-[1.2] whitespace-nowrap">
                  T<span className="whitespace-nowrap favorit-mono">end </span>S<span className="whitespace-nowrap favorit-mono">eed</span>
                </div>
              </button>
              <button
                onClick={onExplore}
