  ...
  return (
    ...
    >
      ...
      <div className="relative mb-4 overflow-hidden pt-4 pb-3">
        {/* Gradient bar */}
        <div className="lg:w-[450px] md:w-[450px] w-[380px] rounded-full py-1 pl-16 pr-4 -ml-4 bg-gradient-to-r from-gray-200 via-white to-gray-200 border-1 border-black scale-[0.85]">
